...
final class GetRepeatingVocabularyState extends VocabulariesState{
  
  const GetRepeatingVocabularyState({required List<Vocabulary> vocabularies}): super(vocabularies: vocabularies);
}